...
$(document).ready(function() {
	...
	$(".filter_btn").mouseenter(function(){
		$(this).toggleClass("active");
		$(".filter_option").slideToggle();
	});
	

	/*$(".fzf_page form *").focus(function(){
		$(".fzf_page").addClass("focused");
	});*/



	$(".fzf_page .form-control").focus(function(){
   	$(".fzf_page").addClass("focused");
	...
	/*$(".fzf_page").click(function(){
       ...
       if ($(window).width() <= 992) {  
              ...
              $(".has-sub-menu").click(function(){
               ...
               $(".login_pop > .btn").click(function(){
					$(".login_pop").children(".login_pop_box").fadeToggle();
				});
